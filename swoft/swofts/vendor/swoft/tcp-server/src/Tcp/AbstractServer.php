...
class AbstractServer  extends  \Swoft\Bootstrap\Server\AbstractServer
{
    use ServerTrait;
    ...
    protected function registerSwooleServerEvents()
    {
        ...
        $swooleServerListeners = $swooleListeners[SwooleEvent::TYPE_SERVER];//注册异步事件
    ...
    public function initSettings(array $settings)
    {
        ...
        $this->tcpSetting = $settings['tcp-server'];
